...
/**
 * Un negocio respondió (o actualizó su respuesta) a una necesidad del
 * comprador (2.2 del TODO). Alimenta el Centro de actividad del Cliente
...
class OfferSubmitted extends Notification implements ShouldQueue
{
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'message' => __(':business respondió a tu solicitud ":need".', [
    ...
    public function toPush(object $notifiable): array
    {
        ...
        return ['title' => __('Nueva propuesta'), 'body' => $data['message'], 'url' => $data['url']];
    }
}
